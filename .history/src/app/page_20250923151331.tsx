...
export default function HomePage() {
  const [_showContactForm, _setShowContactForm] = useState(false);
  ...
  const [questionnaireData, _setQuestionnaireData] = useState({
    brandName: '',
    website: '',
    instagram: '',
    tiktok: '',
  ...
  const _handleQuestionnaireSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
      ...
      >
        ...
        <div className="relative z-10 text-center px-6 sm:px-8 lg:px-12 max-w-6xl mx-auto">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight">
            {/* Riga 1: Letter by letter animation */}
            <span className="block text-white overflow-hidden">
              <span className="inline-block animate-letterByLetter">
                {'Noi investiamo,'.split('').map((char, i) => (
                  <span
                    key={i}
                    className="inline-block"
                    style={{
                      animation: `letterReveal 0.6s cubic-bezier(0.22, 1, 0.36, 1) ${i * 0.03}s both`
                    }}
                  >
                    {char === ' ' ? '\u00A0' : char}
                  </span>
            ...
            {/* Riga 2: Fade up + tracking */}
            <span
              className="block text-white"
              style={{
                animation: 'fadeUpTracking 0.5s cubic-bezier(0.22, 1, 0.36, 1) 0.6s both'
              }}
            >
              tu guadagni,
            </span>

            {/* Riga 3: Gradient sweep con glow */}
            <span
              className="block relative"
              style={{
                animation: 'fadeUp 0.5s cubic-bezier(0.22, 1, 0.36, 1) 1.1s both'
              }}
            >
              <span
                className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent font-bold relative"
                style={{
                  animation: 'gradientSweep 0.8s ease-out 1.3s both',
              ...
              >
                ...
                <span
                  ...
                  style={{
                    animation: 'glowPulse 0.8s ease-out 1.3s both'
                  }}
                />
              </span>
            </span>
          ...
          <p
            ...
            style={{
              animation: 'fadeIn 0.3s ease-out 2.1s both'
            }}
          >
          ...
          <div
            ...
            style={{
              animation: 'fadeIn 0.4s ease-out 2.4s both'
            }}
          >
        ...
        <div
          ...
          style={{
            animation: 'fadeIn 0.5s ease-out 2.7s both'
          }}
        >
