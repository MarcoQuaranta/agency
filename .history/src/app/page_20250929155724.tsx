...
const MetodoSafeScale = dynamic(() => import('@/components/MetodoSafeScale'), {
...
export default function HomePage() {
  ...
  {/* RIGHT – Let's fix it */}
    ...
    <div className="w-full lg:max-w-lg">
      ...
      {/* Metodo SafeScale Section - Apple-style scroll experience */}
      <MetodoSafeScale />
              ...
              <div className="flex items-start gap-4 lg:block">
                <div className="flex-1">
                  <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight" style={{color: '#1c1a31'}}>
                    ...
                    {/* Logo inline solo su desktop */}
                    <Image
                      src="/images/icons/metavett.svg"
                      alt="Meta"
                      width={48}
                      height={48}
                      className="hidden lg:inline-block w-10 h-10 lg:w-12 lg:h-12 ml-2"
                    />
                  </h2>
                </div>
                {/* Meta Logo grande solo su mobile - a destra del titolo */}
                <div className="w-24 h-24 sm:w-28 sm:h-28 lg:hidden flex-shrink-0">
                  <Image
                    src="/images/icons/metavett.svg"
                    alt="Meta"
                    width={96}
