...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white text-custom-dark overflow-x-hidden">
      ...
      >
        {/* Gradient overlay to fade to white at bottom */}
        <div
          className="absolute inset-x-0 bottom-0 h-32 pointer-events-none z-20"
          style={{
            background: 'linear-gradient(to bottom, transparent 0%, rgba(255, 255, 255, 0.4) 50%, rgba(255, 255, 255, 0.8) 90%, #ffffff 100%)'
          }}
        />
